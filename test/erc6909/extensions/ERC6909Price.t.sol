...
contract ERC6909PriceTest is Test {
    ...
    function test_constructorWithZeroTreasury() public {
        vm.expectRevert(
            abi.encodeWithSelector(ERC6909Price.ERC6909PriceInvalidTreasury.selector, address(0))
        );
    ...
    function test_validatePurchaseZeroAmount() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(ERC6909Price.ERC6909PriceInvalidAmount.selector, 0)
        );
