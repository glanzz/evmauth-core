...
contract ERC6909XP20_Test is BaseTest {
    ERC6909XP20 internal token;
    ...
    function setUp() public virtual override {
        ...
        ERC6909XP20 implementation = new ERC6909XP20();

        // Prepare initialization data
        bytes memory initData = abi.encodeWithSelector(
            ERC6909XP20.initialize.selector, 2 days, owner, "https://token-cdn-domain/{id}.json", treasury
        );

        // Deploy proxy and initialize
        address proxyAddress = deployProxy(address(implementation), initData);
        token = ERC6909XP20(proxyAddress);
