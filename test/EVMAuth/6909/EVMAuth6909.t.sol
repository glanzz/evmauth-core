...
import {EVMAuth6909} from "src/EVMAuth/6909/EVMAuth6909.sol";

contract EVMAuth6909_Test is BaseTest {
    EVMAuth6909 internal token;

    function setUp() public virtual override {
        vm.startPrank(owner);
        token = new EVMAuth6909(2 days, owner, "https://token-cdn-domain/{id}.json");
