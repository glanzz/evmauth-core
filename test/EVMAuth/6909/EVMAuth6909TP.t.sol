...
import {EVMAuth6909TP} from "src/EVMAuth/6909/EVMAuth6909TP.sol";

contract EVMAuth6909TP_Test is BaseTest {
    EVMAuth6909TP internal token;

    function setUp() public virtual override {
        vm.startPrank(owner);
        token = new EVMAuth6909TP(2 days, owner, "https://token-cdn-domain/{id}.json", treasury);
