...
import {EVMAuth6909TP20} from "src/EVMAuth/6909/EVMAuth6909TP20.sol";

contract EVMAuth6909TP20_Test is BaseTest {
    EVMAuth6909TP20 internal token;

    function setUp() public virtual override {
        vm.startPrank(owner);
        token = new EVMAuth6909TP20(2 days, owner, "https://token-cdn-domain/{id}.json", treasury);
