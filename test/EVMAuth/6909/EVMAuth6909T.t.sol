...
import {EVMAuth6909T} from "src/EVMAuth/6909/EVMAuth6909T.sol";

contract EVMAuth6909T_Test is BaseTest {
    EVMAuth6909T internal token;

    function setUp() public virtual override {
        vm.startPrank(owner);
        token = new EVMAuth6909T(2 days, owner, "https://token-cdn-domain/{id}.json");
