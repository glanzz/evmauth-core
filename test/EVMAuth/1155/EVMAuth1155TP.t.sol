...
import {EVMAuth1155TP} from "src/EVMAuth/1155/EVMAuth1155TP.sol";

contract EVMAuth1155TP_Test is BaseTest {
    EVMAuth1155TP internal token;

    function setUp() public virtual override {
        vm.startPrank(owner);
        token = new EVMAuth1155TP(2 days, owner, "https://token-cdn-domain/{id}.json", treasury);
