...
import {EVMAuth1155} from "src/EVMAuth/1155/EVMAuth1155.sol";

contract EVMAuth1155_Test is BaseTest {
    EVMAuth1155 internal token;

    function setUp() public virtual override {
        vm.startPrank(owner);
        token = new EVMAuth1155(2 days, owner, "https://token-cdn-domain/{id}.json");
