...
contract ERC1155XT_Test is BaseTest {
    ERC1155XT internal token;
    ...
    function setUp() public virtual override {
        ...
        ERC1155XT implementation = new ERC1155XT();

        // Prepare initialization data
        bytes memory initData =
            abi.encodeWithSelector(ERC1155XT.initialize.selector, 2 days, owner, "https://token-cdn-domain/{id}.json");

        // Deploy proxy and initialize
        address proxyAddress = deployProxy(address(implementation), initData);
        token = ERC1155XT(proxyAddress);
