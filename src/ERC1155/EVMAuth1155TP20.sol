 ...
 * This contract combines {EVMAuth1155P20} with the {TokenTTL} mixin, which adds automatic token expiry
 * for any token type that has a time-to-live (TTL) set.
 */
contract EVMAuth1155TP20 is EVMAuth1155P20, TokenTTL {
    ...
    function initialize(
        ...
        __EVMAuth1155TP20_init(initialDelay, initialDefaultAdmin, uri_, initialTreasury);
    }
     ...
     * @param initialTreasury The address where purchase revenues will be sent.
     */
    function __EVMAuth1155TP20_init(
        uint48 initialDelay,
        address initialDefaultAdmin,
        string memory uri_,
        address payable initialTreasury
     ...
     */
    function __EVMAuth1155TP20_init_unchained() public onlyInitializing {
