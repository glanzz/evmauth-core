...
import {IERC6909Purchase} from "./extensions/IERC6909Purchase.sol";
import {IERC165} from "@openzeppelin/contracts/utils/introspection/IERC165.sol";

/**
 * @dev Extension of ERC6909AccessControlPrice that adds native token purchase functionality.
 * This avoids diamond inheritance by extending AccessControlPrice and implementing purchase methods.
 */
abstract contract ERC6909AccessControlPurchase is ERC6909AccessControlPrice, IERC6909Purchase {
    // Errors
    ...
    function purchase(uint256 id, uint256 amount)
        ...
        returns (bool)
    {
        _purchaseFor(msg.sender, id, amount);
        return true;
    }
