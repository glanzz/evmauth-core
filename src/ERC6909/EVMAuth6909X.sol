 ...
 * This contract combines {EVMAuth6909} with the {TokenExpiry} mixin, which adds automatic token expiry
 * for any token type that has a time-to-live (TTL) set.
 */
contract EVMAuth6909X is EVMAuth6909, TokenExpiry {
    /**
     ...
     * @param uri_ The URI for the contract; see also: https://eips.ethereum.org/EIPS/eip-6909#content-uri-extension
     */
    function __EVMAuth6909X_init(uint48 initialDelay, address initialDefaultAdmin, string memory uri_)
        public
        onlyInitializing
    {
     ...
     */
    function __EVMAuth6909X_init_unchained() public onlyInitializing {
