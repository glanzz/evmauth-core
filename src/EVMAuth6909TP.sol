...
import {EVMAuth6909P} from "./EVMAuth6909P.sol";
...
/**
 * @dev Implementation of an ERC-6909 compliant contract with price management, purchase functionality, and TTL.
 * Combines access control, price management, native token purchase, and expiring token capabilities.
 */
contract EVMAuth6909TP is EVMAuth6909P, ERC6909TTL {
    /**
    ...
    constructor(uint48 initialDelay, address initialDefaultAdmin, address payable treasuryAccount)
        EVMAuth6909P(initialDelay, initialDefaultAdmin, treasuryAccount)
    {}
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC6909AccessControlPurchase, ERC6909TTL)
        returns (bool)
    {
