...
import {EVMAuth1155P} from "./EVMAuth1155P.sol";
...
/**
 * @dev Implementation of an ERC-1155 compliant contract with price management, purchase functionality, and TTL.
 * Combines access control, price management, native token purchase, and expiring token capabilities.
 */
contract EVMAuth1155TP is EVMAuth1155P, ERC1155TTL {
    /**
    ...
    constructor(uint48 initialDelay, address initialDefaultAdmin, address payable treasuryAccount, string memory uri_)
        EVMAuth1155P(initialDelay, initialDefaultAdmin, treasuryAccount, uri_)
    {}
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC1155AccessControlPurchase, ERC1155TTL)
        returns (bool)
    {
