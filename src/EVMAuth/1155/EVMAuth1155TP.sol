...
/**
 * @dev Implementation of an ERC-1155 compliant contract with token time-to-live (TTL) and price management
 * for token purchases with native currency.
 */
contract EVMAuth1155TP is ERC1155XTP, TokenPurchase {
    /**
    ...
    constructor(uint48 initialDelay, address initialDefaultAdmin, string memory uri_, address payable initialTreasury)
        ERC1155XTP(initialDelay, initialDefaultAdmin, uri_, initialTreasury)
    {}
